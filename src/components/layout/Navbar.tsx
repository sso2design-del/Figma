              ...
              {link.isRoute ? (
                <Link
                  ...
                  className={`text-sm font-medium transition-colors flex items-center gap-1 cursor-pointer ${
                    isLightNavbarPage ? "text-gray-700 hover:text-[#001B3D]" : "text-white/80 hover:text-white"
                  }`}
                >
                  {link.name}
                  {link.hasDropdown && (
                      ...
                      <div className="p-3">
                        {link.subMenu.map((item, index) => {
                          ...
                          return (
                            ...
                            >
                              {link.isRoute ? (
                                <Link to={link.href} onClick={() => handleRouteLinkClick()} className={menuItemClassName}>
